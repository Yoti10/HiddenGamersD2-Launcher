//go:generate goversioninfo -icon=icon.ico -manifest=HiddenGamers-launcher.exe.manifest -64
...
import (
	...
	"github.com/Yoti10/HiddenGamersD2-Launcher/bridge"
	"github.com/Yoti10/HiddenGamersD2-Launcher/clients/HiddenGamers"
	"github.com/Yoti10/HiddenGamersD2-Launcher/config"
	"github.com/Yoti10/HiddenGamersD2-Launcher/d2"
	"github.com/Yoti10/HiddenGamersD2-Launcher/news"
...
func main() {
	...
	// Set app context.
	core.QCoreApplication_SetApplicationName("HiddenGamers Launcher")
	core.QCoreApplication_SetOrganizationName("hiddengamers.cl")
	core.QCoreApplication_SetOrganizationDomain("d2hg.ddns.net")
