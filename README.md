...
#### Construyendo el lanzador de HiddenGamers
...
$ go get -d -u -v github.com/Yoti10/HiddenGamersD2-Launcher

# Construye el lanzador
$ cd $(go env GOPATH)/src/github.com/Yoti10/HiddenGamersD2-Launcher
$ qtdeploy build

# Iniciar lanzador (diferente según el sistema operativo)
$ ./deploy/darwin/hiddengamers-launcher.app/Contents/MacOS/HiddenGamers-launcher
```
...
```bash
$ qtdeploy build darwin github.com/Yoti10/HiddenGamersD2-Launcher
```
